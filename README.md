...
<!-- CONTRIBUTIONS:START -->
<p align="center">
  <img src="/metrics.plugin.contributions.svg?v=1789960977" alt="Top Contributed Repos" />
</p>
...
| [**langfuse/langfuse-python**](https://github.com/langfuse/langfuse-python) | 469 | Python | 🪢 Langfuse Python SDK (v4, OpenTelemetry). Tracing: get_client() / start_as_current_observation — n… |
| [**deepset-ai/haystack-core-integrations**](https://github.com/deepset-ai/haystack-core-integrations) | 204 | Python | Additional packages (components, document stores and the likes) to extend the capabilities of Hayst… |
