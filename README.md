...
<!-- CONTRIBUTIONS:START -->
<p align="center">
  <img src="/metrics.plugin.contributions.svg?v=1782271694" alt="Top Contributed Repos" />
</p>
...
|:---|:---:|:---:|:---|
| [**run-llama/llama_index**](https://github.com/run-llama/llama_index) | 50.3k | Python | LlamaIndex is the leading document agent and OCR platform |
...
| [**OpenBMB/ChatDev**](https://github.com/OpenBMB/ChatDev) | 33.5k | Python | ChatDev 2.0: Dev All through LLM-powered Multi-Agent Collaboration |
...
| [**Kilo-Org/kilocode**](https://github.com/Kilo-Org/kilocode) | 24.2k | TypeScript | Kilo is the all-in-one agentic engineering platform. Build, ship, and iterate faster with the most… |
...
| [**confident-ai/deepeval**](https://github.com/confident-ai/deepeval) | 16.4k | Python | The LLM Evaluation Framework |
...
| [**microsoft/presidio**](https://github.com/microsoft/presidio) | 9.5k | Python | An open-source framework for detecting, redacting, masking, and anonymizing sensitive data (PII) ac… |
