...
<!-- CONTRIBUTIONS:START -->
<p align="center">
  <img src="/metrics.plugin.contributions.svg?v=1789874883" alt="Top Contributed Repos" />
</p>
...
|:---|:---:|:---:|:---|
| [**mem0ai/mem0**](https://github.com/mem0ai/mem0) | 65.7k | Python | The Memory Layer for AI Agents - Drop-in memory infrastructure for AI agents and apps. Context that… |
...
| [**langfuse/langfuse-python**](https://github.com/langfuse/langfuse-python) | 468 | Python | 🪢 Langfuse Python SDK (v4, OpenTelemetry). Tracing: get_client() / start_as_current_observation — n… |
